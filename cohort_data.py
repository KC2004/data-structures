def unique_houses(filename):
    ...
    houses_filename = open(filename)
    houses = set()

    for lines in houses_filename:
        line = lines.split('|')
...
def sort_by_cohort(filename):
    ...
    for lines in data_file:
        ...
        line = lines.split("|")
        if line[4] == "Fall 2015":
            fall_15.append("%s %s" % (line[0], line[1]))
        elif line[4] == "Spring 2016":
            spring_16.append("%s %s" % (line[0], line[1]))
        elif line[4] == "Summer 2016":
            summer_16.append("%s %s" % (line[0], line[1]))
        elif line[4] == "Winter 2016":
            winter_16.append("%s %s" % (line[0], line[1]))
        elif line[4] == "G":
            ghosts.append("%s %s" % (line[0], line[1]))
    ...
    all_students = [fall_15, spring_16, summer_16, winter_16, ghosts]
